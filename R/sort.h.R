...
sortOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "sortOptions",
...
sortResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "sortResults",
...
sortBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "sortBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = sortResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
sort <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("sort requires jmvcore to be installed (restart may be required)")
