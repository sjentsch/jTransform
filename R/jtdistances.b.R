...
print("init_2")
                ...
                self$results$crtInf$setVisible(private$.name != "descDistances")
                ...
                self$results$crtInf$setContent(private$.crtMsg())
            } else {
print("init_3")
                ...
                self$results$crtInf$setVisible(FALSE)
...
print("run_1")
        ...
        .crtMsg = function() {
            paste(c(sprintf("<strong>%s</strong> (%d %s in %d %s): %s", .("Variables in the Output Data Set"),
