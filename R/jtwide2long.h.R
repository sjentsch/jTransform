    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Html$new(
                ...
                name="txtHdr",
                refs="jmvReadWrite",
                content="<h2>This function transforms a dataset from wide to long format.</h2>\n"))
            self$add(jmvcore::Html$new(
                options=options,
                name="txtOut",
                content=""))
