...
reorderOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "reorderOptions",
...
reorderResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "reorderResults",
...
reorderBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "reorderBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = reorderResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
reorder <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("reorder requires jmvcore to be installed (restart may be required)")
    ...
    options <- reorderOptions$new(
        varAll = varAll,
        varOrd = varOrd,
        add = add,
        btnOut = btnOut)

    analysis <- reorderClass$new(
        options = options,
        data = data)
